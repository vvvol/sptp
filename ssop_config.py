...
SSOP_TOKEN_FILE = "/mnt/hgst2/ext4/git_work/sptp/.token"
# The command to update 30-days token:
# python everest.py get-token -server_uri https://optmod.distcomp.org -u vladimirv -l sptp -t 2592000 | tee .token30d
UPDATE_TOKEN_PERIOD_IN_SEC = 7*24*3600 - 5*3600

# Working dirs
SSOP_DEFAULT_WORKING_DIR = "./temp"
