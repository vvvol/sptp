...
import ssop_config
from sptpmodel_6_3 import *
from SptpData_6_3 import *

def makeParser():
    parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument('-pr', '--problem', default="dv4", help='problem name')
...
if __name__ == "__main__":
    ...
    theData = SptpData_6_3(args.problem, \
                       path2a_csv='/home/sagingalieva/financial/sptp/data/a_vector.csv', \
                       path2b_csv='/home/sagingalieva/financial/sptp/data/b_vector.csv', \
                       path2C_csv='/home/sagingalieva/financial/sptp/data/c_matrix.csv', \
                       path2D_csv='/home/sagingalieva/financial/sptp/data/d_matrix.csv', \
                       path2P_csv='/home/sagingalieva/financial/sptp/data/p_matrix.csv', \
                       path2S_csv='/home/sagingalieva/financial/sptp/data/s_matrix.csv', \
                       path2T_csv='/home/sagingalieva/financial/sptp/data/t_matrix.csv', \
                       path_sol='/home/sagingalieva/financial/sptp/data/sol.csv',\
                       path_mask='/home/sagingalieva/financial/sptp/data/mask.csv')
    ...
    start_model = timer()
    theModel = SPTPmodel_6_3(theData, isInteger=True, debug=False)
